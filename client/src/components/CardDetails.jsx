                    ...
                    <div className="relative h-[100vh] w-[100vw] flex flex-col">
                        ...
                        >
                            ...
                            <div className="flex flex-row w-full justify-start items-end">
                                ...
                                className="z-10 w-[100px] h-[150px] ml-8 mr-6 mb-3 sm:scale-120 md:scale-150 md:ml-16 md:-translate-y-9 md:mr-12 sm:-translate-y-3 lg:scale-300 lg:ml-40 lg:mr-40 lg:-translate-y-38"/>
                                <button 
